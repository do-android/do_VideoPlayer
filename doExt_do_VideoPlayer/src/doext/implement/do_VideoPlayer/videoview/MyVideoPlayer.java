package doext.implement.do_VideoPlayer.videoview;
...
//	private Activity mActivity;
	...
	public MyVideoPlayer(Activity activity, SurfaceView surfaceView, LinearLayout mediaLinerLayout, ImageView ivFullscreen, TextView time_current, TextView time, SeekBar mediacontroller_progress) {
...
//			mediaPlayer.start();
		...
		Log.e("mediaPlayer", "playUrl state = " + mCurrentState);
	}
